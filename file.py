...
#     top_description_text = models.CharField(max_length=100)
#     middle_description_text = models.CharField(max_length=100)
#     bottom_description_text = models.CharField(max_length=100)
#     red_text = models.CharField(max_length=100)
...
#     standard_label_color = models.CharField(max_length=100)
